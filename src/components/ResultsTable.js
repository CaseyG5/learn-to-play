...
export default function ResultsTable( { content, loggedIn, addToFaves } ) {
    ...
    for(let i=0; i<10; i++ ) {
        ...
        rows.push(<ResultRow imgURL={img} vidTitle={title} vidDesc={desc} vidID={id} key={id} loggedIn={loggedIn} addToFaves={addToFaves}/>);
    }
